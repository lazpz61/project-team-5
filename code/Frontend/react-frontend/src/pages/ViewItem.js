...
//Upon a successful response, it logs the data, navigates to a different route, and optionally updates the equipment data.
    fetch("https://gear-on-the-go-cd52acec7ae4.herokuapp.com//api/addEquipment", {
      method: "POST",
      headers: {
...
//This function fetches the equipment from the database server
  const fetchEquipmentData = () => {
    fetch("https://gear-on-the-go-cd52acec7ae4.herokuapp.com//api/getEquipment")
      .then((response) => response.json())
...
//This function fetches the reservations from the database server
  const fetchReservationData = () => {
    fetch("https://gear-on-the-go-cd52acec7ae4.herokuapp.com//api/getReservation")
      .then((response) => response.json())
...
//This function fetches the reviews from the database server
  const fetchReviewsData = () => {
    fetch(`https://gear-on-the-go-cd52acec7ae4.herokuapp.com//api/getReviews/${username}`)
      .then((response) => response.json())
...
//This function handles the removal and sends a confirmaiton of the removal
  const handleRemoveConfirm = () => {
    ...
    fetch(`https://gear-on-the-go-cd52acec7ae4.herokuapp.com//api/removeEquipment/${selectedItem.itemid}`, {
      method: "DELETE",
    })
      .then((response) => response.json())
      .then((data) => {
...
// This function is used to make a PUT request to update the equipment data on the database
  const handleUpdateSubmit = (event) => {
    ...
    fetch(`https://gear-on-the-go-cd52acec7ae4.herokuapp.com//api/updateEquipment/${updateFormData.id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
...
//If it's not defined (i.e., no item is selected), it logs an error message to the console and exits the function.
  ...
  const handleRemoveReservationConfirm = () => {
    ...
    fetch(
      ...
      `https://gear-on-the-go-cd52acec7ae4.herokuapp.com//api/removeReservation/${selectedReservation.reservation_id}`,
      {
        method: "DELETE",
      }
    )
...
//logs the response data, fetches updated reservation data, and closes the update modal.
  const handleUpdateReservationSubmit = (event) => {
    ...
    fetch(
      `https://gear-on-the-go-cd52acec7ae4.herokuapp.com//api/updateReservation/${updateReservationData.reservation_id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
