...
function UserProfile() {
  ...
  const fetchEquipmentData = () => {
    fetch(`https://gear-on-the-go-cd52acec7ae4.herokuapp.com//api/items/${usernameSelected}`)
  ...
  const fetchReviewsData = () => {
    fetch(`https://gear-on-the-go-cd52acec7ae4.herokuapp.com//api/getReviews/${usernameSelected}`)
      .then((response) => response.json())
  ...
  const handleReviewSubmit = (event) => {
    ...
    fetch("https://gear-on-the-go-cd52acec7ae4.herokuapp.com//api/addReviews", {
      method: "POST",
      headers: {
